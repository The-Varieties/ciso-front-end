...
export const RecommendationContent = (props) => {
    ...
    return(
        <div>
                ...
                props.recommendationsList.map((recommendation, index) => {
                    ...
                    return (
                        <div className="mt-3" key={index}>
                            ...
                            <p className="text-black w-fit text-sm italic font-bold">{recommendation.steps[0] !== '' ? 'How-to:' : ''}</p>
            ...
            :
            <div>
                <p className="text-indigo-800 w-fit font-black text-base">Loading...</p>
            </div>
            )}
        </div>
    )
